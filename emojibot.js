    ...
    if (message.content.startsWith('!CAH')) {
        ...
        message.reply('The bot will now shut down.\n' +
            ...
            .then(function(message) {
                message.react("<:b99:643161128494432256>")
                message.react("👎")
                CAH = message
                message.awaitReactions((reaction, user) => user.id == author && (reaction.emoji.name == '<:b99:643161128494432256>' || reaction.emoji.name == '👎'), { max: 1, time: 30000 }).then(collected => {
